...
const Hero = () => {
  return (
    <section
      id="home"
      className="pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-r from-gm-blue to-gm-darkblue text-white relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 animate-fade-in">
            ...
            <p className="text-lg md:text-xl opacity-90 mb-8 max-w-lg">
              Providing quality, speedy, efficient, and cost-effective
              electrical services & solutions across Rwanda and East Africa
              since 2004.
            </p>
            ...
            {[
              {
                ...
                desc: "Expert electrical maintenance & repair",
              },
              {
                icon: <Zap size={32} />,
              ...
              },
              {
                ...
                desc: "Comprehensive service contracts",
              },
              {
                icon: <Truck size={32} />,
                title: "Supply & Distribution",
                desc: "Quality electrical equipment & parts",
              },
            ].map((item, index) => (
              <div
                key={index}
        ...
        <div className="mt-16 hidden lg:flex gap-4 justify-center animate-fade-in">
          {[construct, road, stadium].map((img, index) => (
            <div
              key={index}
              className="w-64 h-36 rounded-lg overflow-hidden shadow-md transform hover:scale-105 transition-transform hover:-translate-y-1"
            >
              <img
                src={img}
                alt={`Engineer work ${index + 1}`}
