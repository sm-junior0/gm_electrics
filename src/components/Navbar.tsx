    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <span className="text-2xl font-bold text-gm-yellow">GM <span className={isScrolled ? "text-gm-gray" : "text-white"}>Electrics</span></span>
        </div>
              ...
              <li key={item}>
                <a 
                  ...
                  className={`font-medium transition-colors ${
                    isScrolled ? "text-gm-gray hover:text-gm-blue" : "text-white hover:text-gm-yellow"
                  }`}
                >
                  {item}
                </a>
