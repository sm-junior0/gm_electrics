  ...
  const services = [
    {
      ...
      description:
        "Professional repair and maintenance of electrical motors, generators, and transformers with expert precision.",
    },
    {
      icon: <Zap className="w-10 h-10 text-gm-yellow" />,
      title: "Electrical Contracting",
      description:
        "Comprehensive electrical contracting and consultancy services for commercial and industrial projects.",
    },
    {
      icon: <Truck className="w-10 h-10 text-gm-yellow" />,
      title: "Generator Solutions",
      description:
        "Supply, installation, and commissioning of diesel generators with full support and maintenance.",
    },
    {
      icon: <Building className="w-10 h-10 text-gm-yellow" />,
      title: "Building Maintenance",
      description:
        "Specialized maintenance and service contracts for commercial and residential buildings.",
    },
    {
      icon: <Lightbulb className="w-10 h-10 text-gm-yellow" />,
      title: "Electrical Supplies",
      description:
        "Sales of cables, electrical accessories, and motor starters with guaranteed quality and reliability.",
    },
    {
      icon: <Rocket className="w-10 h-10 text-gm-yellow" />,
      title: "Refrigeration & AC",
      description:
        "Professional refrigeration and air conditioning contracting services for commercial and residential needs.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gm-gray">
            We provide a comprehensive range of electrical and engineering
            services to meet the needs of residential, commercial, and
            industrial clients throughout Rwanda and East Africa.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-gm-darkblue mb-3">
                  {service.title}
                </h3>
